...
L:RegisterTranslations("zhCN", function()
    return {
    	...
    	["Upwards"] = "向上",
		["Downwards"] = "向下",
		["Growth Precedence"] = "优先增长方向",
		["In which direction should the display grow first (horizontally or vertically)?"] = "先左右排列还是上下排列图标",
		["Horizontally"] = "水平",
		["Vertically"] = "纵向",
------------------------------------------------------ 15:44
...
----------------------------------------------------
		["Hide"] = "隐藏",
		["Hides these buff frames"] = "隐藏Buff框体",
		["Verbose Timers"] = "精确计时",
...
-------------------------------------------------------
		...
		["White Timers"] = "白色显示方式",
		["Use white timers instead of yellow ones"] = "白色计时显示",
-----------------------------------------------------------
		["config"] = "设置",
		["Config"] = "设置",
-----------------------------------------------------------
