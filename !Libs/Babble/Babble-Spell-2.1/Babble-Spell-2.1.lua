--[[
Name: Babble-Spell-2.1
Revision: $Rev: 12847 $
Author(s): eternally777 (eternally777@gmail.com)
Based On: BabbleLib-2.0 by ckknight
Website: http://www.wowace.com/index.php/Babble-Spell-2.1
Documentation: http://www.wowace.com/index.php/Babble-Spell-2.1
SVN: http://svn.wowace.com/root/trunk/BabbleLib/BabbleLib-2.1/Babble-Spell-2.1
Description: A library to provide localizations for spells.
Dependencies: AceLibrary, AceLocale-2.1
]]

local MAJOR_VERSION = "Babble-Spell-2.1"
local MINOR_VERSION = tonumber(string.sub("$Revision: 12847 $", 12, -3))
...
if AceLocale:HasInstance(MAJOR_VERSION) then
    BabbleSpell = AceLocale:GetInstance(MAJOR_VERSION)
    if not BabbleSpell:NeedsUpgrade(MINOR_VERSION) then return end
    BabbleSpell:ClearLocales()
end
...
AceLocale:RegisterTranslation(MAJOR_VERSION, "zhTW", function()
	return {
...
BabbleSpell = AceLocale:GetInstance(MAJOR_VERSION, true)
BabbleSpell:SetStrictness(true)

function BabbleSpell:NeedsUpgrade(revision)
...
function BabbleSpell:GetSpellIcon(spell)
    local icon = spellIcons[spell] or spellIcons[self:HasReverseTranslation(spell) and self(spell, "reverse") or false]
    if not icon then
        return nil
    end
...
function BabbleSpell:GetShortSpellIcon(spell)
    return spellIcons[spell] or spellIcons[self:HasReverseTranslation(spell) and self(spell, "reverse") or false]
end