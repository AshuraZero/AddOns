...
surface:Register("Diagonal", "Interface\\Addons\\XRS\\images\\Diagonal")
surface:Register("BantoBar", "Interface\\Addons\\XRS\\images\\BantoBar")
surface:Register("Skewed", "Interface\\Addons\\XRS\\images\\Skewed")
surface:Register("Smooth", "Interface\\Addons\\XRS\\images\\Smooth")
surface:Register("Otravi", "Interface\\Addons\\XRS\\images\\Otravi")
surface:Register("Charcoal", "Interface\\Addons\\XRS\\images\\Charcoal")
surface:Register("Rounded", "Interface\\Addons\\XRS\\images\\Rounded")
surface:Register("Granite", "Interface\\Addons\\XRS\\images\\Granite")
surface:Register("Waves", "Interface\\Addons\\XRS\\images\\Waves")
...
function XRS:OnEnable()
	self:RegisterEvent("Surface_Registered", function()
		self.options.args.texture.validate = self.surface:List()
		self.options.args.texture.validate = self.surface:List()
	end)
...
function XRS:SetupBars()    
	...
	local texture = self.db.profile.Texture
	
    for k,v in bt do
        -- get the data
        local d = bt[k]
        -- create the bar
        local bar = self.bar:new(k, d, surface:Fetch(texture))
...
function XRS:SetBarTexture(name)
    ...
    for _,v in ipairs(self.bars)do
        v:SetBarTexture(surface:Fetch(name))
    end
end
