...
MCP_PROFILE_DELETE = "Profile deleted: ";
...
MCP_ADDON_WILL_NOT_LOAD = "将禁用";
MCP_ADDON_REFUSE_TO_LOAD = "在MCP中禁用";
MCP_LOADED_ON_DEMAND = "动态加载.";

MCP_RELOAD = "重新载入所有插件?";
MCP_DELETE_PROFILE_DIALOG = "删除设置: ";
MCP_PROFILE_NAME_SAVE = "设置名称";

MCP_PROFILE_SAVED = "设置已保存: ";
MCP_PROFILE_DELETE = "设置已删除: ";
MCP_NO_PROFILE_DELETED = "没有设置可删除.";

MCP_LOAD = "加载";
MCP_ADDONS = "插件管理";
MCP_RELOADUI = "重载所有插件";
MCP_SAVE_PROFILE = "保存设置";
MCP_DELETE_PROFILE = "删除设置";
MCP_ENABLE_ALL = "启用所有";
MCP_DISABLE_ALL = "禁用所有";
