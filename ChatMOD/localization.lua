...
elseif ( GetLocale() == "zhCN" ) then
	...
	SCCN_HELP[18]			= "|cff68ccef".."/chatmod AutoBGMap".."|cffffffff".." 自动打开战场迷你地图.";	
	...
	SCCN_HELP[22]					= "|cff68ccef".."/chatmod inchathighlight ".."|cffffffff".."高亮已知昵称";	
	SCCN_HELP[23]					= "|cff68ccef".."/chatmod sticky ".."|cffffffff".."保持上次对话动作";	
	SCCN_HELP[24]					= "|cff68ccef".."/chatmod initchan <channelname>".."|cffffffff".."起动时设置指定的<频道名>在默认聊天框.";		
	SCCN_HELP[25]					= "|cff68ccef".."/chatmod nofade".."|cffffffff".."关闭聊天文字淡出";
