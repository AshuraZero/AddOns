...
Heart_GUI_MT_priority = "MT priority"
...
Heart_GUI_scale_hots="Scale HOTs"
...
--adv
Heart_GUI_CastTime_Debuff= "CastTime DeBuff"
Heart_GUI_MTCastTime_Debuff= "MT CastTime DeBuff"
...
Heart_GUI_help = {
	...
	["Heart_GUISpellSelect%dAttachment"] = {
		["Title"] = "",
		["Description"] = "Click this spell to \"Attach\" it to a spell in this HealClass. \"Attach\" this spell to another by clicking on the spell you wish to attach it to or by setting the percentage slider to the spell you wish to attach it to. At that spells percent, this spell will be cast first if it is able to be cast. Shields can be given an independant percentage"
	},
...
Heart_about_text="redHeart   --bend on liberating all healers\nautotargetting; autoscaling; overheal-monitor; clickheal; sync; strategy-adjust\n2006 by raynorli,  based on Heart, Genesis\nWebsite: http://http://www.curse-gaming.com/en/wow/addons-5568-1-redheart.html\use \"/heart gui\" to open button panel; \"/heart opt\" to open option panel; \"/heart help\" to see command list. See readme.txt for addon usage"