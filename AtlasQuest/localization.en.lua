...
AQDiscription_AIM = "Object: \n"
AQDiscription_NOTE = "Note: \n"
AQDiscription_PREQUEST= "Prequest: "
AQDiscription_FOLGEQUEST = "Quest follows: "
ATLAS_VERSIONWARNINGTEXT = "You are currently using an old or outdated version of Atlas. Please update to the newest version: 1.8.3."
...
Inst1Quest1_Note = "You can get the Red Silk Bandanas from miners in the Deadmines or the in the town where the instance is located."
...
Inst1Quest2_Note = "The Undeads (elite), shortly before you enter the instance, drop the cards."
...
Inst1Quest3_Note = "The elite undead monsters just outside the instance drop the Badge."
...
Inst1Quest4_Note = "The prequest can be obtained from Gnoarn (Ironforge; 69,50).\nSneed's Shredder drops the Sprecklesprocket "..YELLOW.."[3]"..WHITE.."."
...
Inst1Quest6_Page = {2, "Only Paladins can get this quest!\n1. You get the  Whitestone Oak Lumber from Goblin Woodcarvers in "..YELLOW.."[Deadmines]"..WHITE..".\n2. To get the Bailor's Refined Ore Shipment you must talk to Bailor Stonehand (Loch Modan; 35,44 ). He gives you the 'Bailor's Ore Shipment' quest. You find the Jordan's Ore Shipment behind a tree at 71,21\n3. You get Jordan's Smithing Hammer in "..YELLOW.."[Shadowfang Keep]"..WHITE.." next to "..YELLOW.."[B]"..WHITE.." (the stables).\n4. To get a Kor Gem you have to go to Thundris Windweaver (Darkshore; 37,40) and do the 'Seeking the Kor Gem' quest. For this quest, you must kill Blackfathom oracles or priestesses before "..YELLOW.."[Blackfathom Deeps]"..WHITE..". They drop a corrupted Kor Gem. Thundris Windweaver will clean it for you.", };
...
Inst2Quest1_Note = "All deviate mobs inside of and right before the entrance to the instance can drop hides. Nalpak can be found in a hidden cave above the actual cave entrance."
...
Inst2Quest2_Note = "You get the bottle right before you go into the instance by killing Mad Magglish. When you first enter the cave make an immediate right to find him at the end of the passage. He is stealthed by the wall."
...
Inst2Quest4_Note = "Ebru is in a hidden cave above the cave entrance."
...
Inst2Quest5_Note = "The glowing shard can be obtained from the last boss, Mutanus the Devourer. Mutanus the Devourer will only appear if you kill the four leader druids of the fang and escort the tauren druid at the entrance."..YELLOW.."[9]"..WHITE..".\nWhen you have the Shard, you must bring it to Ratchet (bank), and then back to the top of the hill over Wailing Caverns to Falla Sagewind."
...
Inst24Quest4_Note = "All enemies found inside the instance drops Red Wool Bandanas."
...
Inst24Quest5_Note = "The preceding quest can be obtained from Motley too.\nYou can find Kam Deepfury at "..YELLOW.."[2]"..WHITE.."."
...
Inst17Quest1_Note = "You can find the mobs in the area just before the instance entrance."
...
Inst17Quest2_Note = "You can find Belnistrasz at "..YELLOW.."[2]"..WHITE.."."
...
Inst17Quest1_HORDE_Note = "The mobs can be found in the area just before the entrance to the instance."
...
Inst17Quest2_HORDE_Note = "The preceding quest can be obtained from the last Boss in Razorfen Kraul.\n You find Malcin outside(The Barrens, 48,92)."
...
Inst19Quest1_Note = "You can find the book in the Libary of Scarlet Monastery."
...
Inst19Quest2_Note = "This quest line starts at Brother Crowley (42,24 in Stormwind).\nYou can find High Inquisitor Whitemane and Kommandant Mograinebei at "..YELLOW.."[5]"..WHITE..", Herod at "..YELLOW.."[3]"..WHITE.." and Houndmaster Loksey at "..YELLOW.."[1]"..WHITE.."."
...
Inst19Quest3_Note = "This quest can only be obtained by mages.\nYou can find the book in the Libary of Scarlet Monastery."
...
Inst19Quest1_HORDE_Note = "You can find Vorrel Sengutz at the beginning of the Graveyard section of the Scarlet Monastery. Nancy, who drops the ring needed for this quest, can be found in a house in the Alterac Mountains(31,32)."
...
Inst19Quest2_HORDE_Note = "For more details about the preceding quest see "..YELLOW.."[Razorfen Kraul]"..WHITE.."\nAll mobs in the Scarlet Monastery drop Hearts of Zeal."
...
Inst19Quest4_HORDE_Note = "You can find the book in the Libary section of the Scarlet Monastery."
...
Inst19Quest5_HORDE_Note = "You can find High Inquisitor Whitemane and Kommandant Mograinebei at "..YELLOW.."[5]"..WHITE..", Herod at "..YELLOW.."[3]"..WHITE.." and Houndmaster Loksey at "..YELLOW.."[1]"..WHITE.."."
...
Inst19Quest6_HORDE_Note = "This quest can only be obtained by mages.\nYou can find the book in the Libary section of the Scarlet Monastery."
...
Inst18Quest3_Note = "Willix is at "..YELLOW.."[8]"..WHITE..". You must escort him to the entrance of the instance."
...
Inst18Quest5_Note = "This quest can only be obtained by warriors.\nYou get the Vial of Phlogiston at "..YELLOW.."[1]"..WHITE.."."
...
Inst18Quest2_HORDE_Note = "Willix is at "..YELLOW.."[8]"..WHITE..". You must escort him to the entrance of the instance."
...
Inst18Quest5_HORDE_Note = "This quest can only be obtained by warriors.\nYou get the Vial of Phlogiston at "..YELLOW.."[1]"..WHITE.."."
...
Inst20Quest2_Note = "Plagued Hatchlings drop the Healthy Dragon Scales (8% chance to drop). You can find Betina Bigglezink at 81,59."
...
Inst20Quest3_Note = "You can find Doctor Theolen Krastinov at "..YELLOW.."[9]"..WHITE.."."
...
Inst20Quest4_Note = "You can find Yesndice Barov at "..YELLOW.."[3]"..WHITE.."."
...
Inst20Quest6_HORDE_Note = "You can find Ras Frostwhisper at "..YELLOW.."[7]"..WHITE.."."
...
Inst7Quest2_Note = "You get the Prequest from Argos Nightwhisper (Stormwind; 21,55). All the Nagas before and in Blackfathomdeeps drop the brains."
...
Inst7Quest4_Note = "You get this Quest from Thaelrid at "..YELLOW.."[4]"..WHITE..". Kelris is at "..YELLOW.."[8]"..WHITE..". ATTENTION! If you turn on the flames beside Lord Kelris, enemies appear and attack you. You find Dawnwatcher Selgorm in Darnassus (55,24)"
...
Inst25Quest3_HORDE_Folgequest = "No"
...
Inst25Quest4_HORDE_Prequest = "Yes, The Stone Circle"
...
Inst21Quest2_Location = "Doan Karhan (Barrens; "..YELLOW.."49,67"..WHITE..")"
Inst21Quest2_Note = "Only Warlocks can get this Quest! You get the 3 Soran'ruk Fragmentes from Twilight-Akolyts in "..YELLOW.."[Blackfathomdeeps]"..WHITE..". You get the Large Soran'ruk Fragment in "..YELLOW.."[Shadowfang Keep]"..WHITE.." from Shadowfang Darksouls."
...
Inst5Quest3_Note = "You get the Giant Silver Veins from Giants in Azshara. Gromsblood can be most easily acquired from either an herbalist or at the AH. Lastly, the vial can be filled at the Go-Lakka crater (Un'Goro Crater; 31,50).\nAfter completing the quest, you can use the backdoor instead of killing Phalanx."
...
Inst5Quest6_Note = "You find the Heart at "..YELLOW.."[10]"..WHITE.." in a safe. You get the key for the safe from Warder Stillgiss. He appears after opening all small safes."
...
Inst5Quest15 = "15. Attunement to the Core"
...
Inst5Quest15_Location = "Lothos Riftwaker (Blackrock Mountain; "..YELLOW.."Next to the Entrance of BRD"..WHITE..")"
Inst5Quest15_Note = "After comleting this quest, you can use the stone next to Lothos Riftwaker to enter the Molten Core.\nYou find the Core Fragment near "..YELLOW.."[23]"..WHITE.."."
...
Inst5Quest5_HORDE_Note = "You find the Heart at "..YELLOW.."[10]"..WHITE.." in a safe. You get the key for the safe from Warder Stillgiss. He appears after opening all small safes."
...
Inst5Quest15_HORDE = "15. Attunement to the Core"
Inst5Quest15_HORDE_Attain = "55"
Inst5Quest15_HORDE_Level = "60"
Inst5Quest15_HORDE_Aim = "Venture to the Molten Core entry portal in Blackrock Depths and recover a Core Fragment. Return to Lothos Riftwaker in Blackrock Mountain when you have recovered the Core Fragment."
Inst5Quest15_HORDE_Location = "Lothos Riftwaker (Blackrock Mountain; "..YELLOW.."Next to the Entrance of BRD"..WHITE..")"
Inst5Quest15_HORDE_Note = "After comleting this quest, you can use the stone next to Lothos Riftwaker to enter the Molten Core.\nYou find the Core Fragment near "..YELLOW.."[23]"..WHITE.."."
Inst5Quest15_HORDE_Prequest = "No"
Inst5Quest15_HORDE_Folgequest = "No"
...
Inst13Quest3_Note = "Most enemies in Maraudon drop the Carvings.(high droprate)"
...
Inst13Quest4_Page = {2, "You find the Centaur Pariah in the south of desolace. He walks between 44,85 and 50,87.\nFirst, you have to kill the 'Unnamed Prophet'. You find him before you enter the instance, before the point where you can choose whether you take the purple or the orange entrance. After killing him you must kill the 5 Kahns. You find the first if you choose the way in the middle (not purple not orange). The second is in the purple part of Maraudon but before you enter the instance. The third is in the orange part before you enter the instance (on the longer way to go to the instance). The fourth is near "..YELLOW.."[4]"..WHITE.." and the fifth is near  "..YELLOW.."[1]"..WHITE..".", };
...
Inst13Quest5_Location = "Cavindra (Desolace - Maraudon "..YELLOW..""..WHITE..")"
...
Inst13Quest6_Location = "Celebras the Redeemed (Maraudon "..YELLOW..""..WHITE..")"
...
Inst13Quest7_Location = "Keeper Marandis (Desolace; "..YELLOW.."63,10"..WHITE..")"
...
Inst13Quest8_Note = "Zaetars Ghost appears after killing the Princess("..YELLOW.."[11]"..WHITE..").\nYou find Remulos in Moonglade "..YELLOW.."(36,41)"..WHITE.."."
...
Inst13Quest4_HORDE_Page = {2, "You find the Centaur Pariah in the south of desolace. He walks between 44,85 and 50,87.\nFirst, you have to kill the 'Unnamed Propheten'. You find him before you enter the instance, before the point where you can chosse whether you take the purple or the orange entrance. After killing him you musst kill the 5 Kahns. You find the first if you chosse the way in the middle(not purple not orange). The second is in the pruple part of Maraudon but before you enter the instance. The thrid is in the orange part before you enter the instance(on the longer way to go to the instance). The fourth is near "..YELLOW.."[4]"..WHITE.." and the fifth is near  "..YELLOW.."[1]"..WHITE..".", };


--Quest5 Horde

Inst13Quest5_HORDE = "5. Legends of Maraudon"
Inst13Quest5_HORDE_Attain = "?"
Inst13Quest5_HORDE_Level = "48"
Inst13Quest5_HORDE_Aim = "Recover the two parts of the Scepter of Celebras: the Celebrian Rod and the Celebrian Diamond.\nFind a way to speak with Celebras."
Inst13Quest5_HORDE_Location = "Cavindra (Desolace - Maraudon "..YELLOW..""..WHITE..")"
Inst13Quest5_HORDE_Note = "You find Cavindra at the beginning  of the orange part before you enter the instance.\nYou get the Celebrian Rod from Noxxion at "..YELLOW.."[2]"..WHITE..", the Celebrian Diamond from Lord Vyletongue at  "..YELLOW.."[5]"..WHITE..". Celebras is at "..YELLOW.."[7]"..WHITE..". You have to defeat him to be able to talk to him."
Inst13Quest5_HORDE_Prequest = "No"
Inst13Quest5_HORDE_Folgequest = "Yes, The Scepter of Celebras"

--Quest6 Horde

Inst13Quest6_HORDE = "6. The Scepter of Celebras"
Inst13Quest6_HORDE_Attain = "?"
Inst13Quest6_HORDE_Level = "49"
Inst13Quest6_HORDE_Aim = "Assist Celebras the Redeemed while he creates the Scepter of Celebras.\nSpeak with him when the ritual is complete."
Inst13Quest6_HORDE_Location = "Celebras the Redeemed (Maraudon "..YELLOW..""..WHITE..")"
Inst13Quest6_HORDE_Note = "Celebras creats the Szepter. Speak with him after he finish."
Inst13Quest6_HORDE_Prequest = "Yes, Legends of Maraudon"
Inst13Quest6_HORDE_Folgequest = "No"
...
Inst13Quest7_HORDE_Location = "Selendra (Desolace; "..YELLOW.."26,77"..WHITE..")"
...
Inst13Quest8_HORDE = "8. Seed of Life"
Inst13Quest8_HORDE_Attain = "?"
Inst13Quest8_HORDE_Level = "51"
Inst13Quest8_HORDE_Aim = "Seek out Remulos in Moonglade and give him the Seed of Life."
Inst13Quest8_HORDE_Location = "Zaetars Ghost (Maraudon "..YELLOW.."[11]"..WHITE..")"
Inst13Quest8_HORDE_Note = "Zaetars Ghost appears after killing the Princess("..YELLOW.."[11]"..WHITE..").\nYou find Remulos in Moonglade "..YELLOW.."(36,41)"..WHITE.."."
Inst13Quest8_HORDE_Prequest = "Yes, Corruption of Earth and Seed"
Inst13Quest8_HORDE_Folgequest = "No"
Inst13Quest8FQuest_HORDE = "true"
...
Inst22Quest1_Location = "Betina Bigglezink (Eastern Plaguelands; "..YELLOW.."81,59"..WHITE..")"
Inst22Quest1_Note = "Most enemies in Stratholme can drop the Flesh."
...
Inst22Quest2_Location = "Betina Bigglezink (Eastern Plaguelands; "..YELLOW.."81,59"..WHITE..")"
Inst22Quest2_Note = "The Scourge Data is in one of the 3 Towers, you find near "..YELLOW.."[10]"..WHITE..", "..YELLOW.."[11]"..WHITE.." and "..YELLOW.."[12]"..WHITE.."."
...
Inst22Quest3_Location = "Leonid Barthalomew the Revered (Eastern Plaguelands; "..YELLOW.."80,58"..WHITE..")"
...
Inst22Quest4_Location = "Smokey LaRue (Eastern Plaguelands; "..YELLOW.."80,58"..WHITE..")"
Inst22Quest4_Note = "You find the smoke shop near "..YELLOW.."[1]"..WHITE..". Fras Siabi spanws when you open box."
...
Inst22Quest5_Location = "Egan (Eastern Plaguelands(NW); "..YELLOW.."14,33"..WHITE..")"
Inst22Quest5_Note = "You get the prequest from Caretaker Alen (Eastern Plaguelands; "..YELLOW.."79,63"..WHITE..")\nThe spectral citizens walk through whole Stratholme."
...
Inst22Quest6 = "6. Of Love and Family (Questline)"
...
Inst22Quest6_Location = "Artist Renfray (Western Plaguelands; "..YELLOW.."65,75"..WHITE..")"
Inst22Quest6_Note = "You get the prequest from Tirion Fordring(Western Plaguelands; "..YELLOW.."7,43"..WHITE..").\nYou can find the picture near "..YELLOW.."[7]"..WHITE.."."
...
Inst22Quest7 = "7. Menethil's Gift (Questline)"
...
Inst22Quest7_Location = "Leonid Barthalomew the Revered (Eastern Plaguelands; "..YELLOW.."80,58"..WHITE..")"
Inst22Quest7_Note = "You get the prequest from Magistrat Marduke (Western Plaguelands; "..YELLOW.."70,73"..WHITE..").\nYou find the sign near "..YELLOW.."[15]"..WHITE..". See also: "..YELLOW.."[The Lich Ras Frostraunen]"..WHITE.." in Scholomance."
...
Inst22Quest8_Note = "To start the quest you have to give Aurius the [The Medallion of Faith]. You get the Medallion from a chest(Malor's Strongbox) near "..YELLOW.."[6]"..WHITE..". After giving Aurius the Medallion he supports your group in the fight against the Baron("..YELLOW.."[15]"..WHITE.."). After killing the Baron you have to talk to Aurius again to get the Rewards."
...
Inst22Quest9_Location = "Duke Nicholas Zverenhoff (Eastern Plaguelands; "..YELLOW.."81, 59"..WHITE..")"
Inst22Quest9_Note = "You can find the Archive and the Achivist at "..YELLOW.."[6]"..WHITE.."."
...
Inst22Quest10_Note = "You find Duke Nicholas Zverenhoff in the Eastern Plaguelands("..YELLOW.."81, 59"..WHITE..")."
...
Inst22Quest11_Location = "Duke Nicholas Zverenhoff (Eastern Plaguelands; "..YELLOW.."81, 59"..WHITE..")"
Inst22Quest11_Note = "You can find the Baron at "..YELLOW.."[15]"..WHITE.."."
...
Inst22Quest1_HORDE = "1. The Flesh Does Not Lie"
Inst22Quest1_HORDE_Attain = "?"
Inst22Quest1_HORDE_Level = "60"
Inst22Quest1_HORDE_Aim = "Recover 20 Plagued Flesh Samples from Stratholme and return them to Betina Bigglezink. You suspect that any creature in Stratholme would have said flesh sample."
Inst22Quest1_HORDE_Location = "Betina Bigglezink (Eastern Plaguelands; "..YELLOW.."81,59"..WHITE..")"
Inst22Quest1_HORDE_Note = "Most enemies in Stratholme can drop the Flesh."
Inst22Quest1_HORDE_Prequest = "No"
Inst22Quest1_HORDE_Folgequest = "Yes, The Active Agent"

--Quest2 Horde

Inst22Quest2_HORDE = "2. The Active Agent"
Inst22Quest2_HORDE_Attain = "58"
Inst22Quest2_HORDE_Level = "60"
Inst22Quest2_HORDE_Aim = "Travel to Stratholme and search the ziggurats. Find and return new Scourge Data to Betina Bigglezink."
Inst22Quest2_HORDE_Location = "Betina Bigglezink (Eastern Plaguelands; "..YELLOW.."81,59"..WHITE..")"
Inst22Quest2_HORDE_Note = "The Scourge Data is in one of the 3 Towers, you find near "..YELLOW.."[10]"..WHITE..", "..YELLOW.."[11]"..WHITE.." and "..YELLOW.."[12]"..WHITE.."."
Inst22Quest2_HORDE_Prequest = "Yes, The Flesh Does Not Lie"
...
Inst22Quest3_HORDE = "3. Houses of the Holy"
Inst22Quest3_HORDE_Attain = "?"
Inst22Quest3_HORDE_Level = "60"
Inst22Quest3_HORDE_Aim = "Travel to Stratholme, in the north. Search the supply crates that litter the city and recover 5 Stratholme Holy Water. Return to Leonid Barthalomew the Revered when you have collected enough of the blessed fluid."
Inst22Quest3_HORDE_Location = "Leonid Barthalomew the Revered (Eastern Plaguelands; "..YELLOW.."80,58"..WHITE..")"
Inst22Quest3_HORDE_Note = "You can find the Holy Water in chests everywhere in Stratholme. But if you open a chest bugs can appear and attack you."
Inst22Quest3_HORDE_Prequest = "No"
...
Inst22Quest4_HORDE = "4. The Great Fras Siabi"
Inst22Quest4_HORDE_Attain = "?"
Inst22Quest4_HORDE_Level = "60"
Inst22Quest4_HORDE_Aim = "Find Fras Siabi's smoke shop in Stratholme and recover a box of Siabi's Premium Tobacco. Return to Smokey LaRue when the job is done."
Inst22Quest4_HORDE_Location = "Smokey LaRue (Eastern Plaguelands; "..YELLOW.."80,58"..WHITE..")"
Inst22Quest4_HORDE_Note = "You find the smoke shop near "..YELLOW.."[1]"..WHITE..". Fras Siabi spanws when you open box."
Inst22Quest4_HORDE_Prequest = "No"
Inst22Quest4_HORDE_Folgequest = "No"
--
Inst22Quest4name1_HORDE = "Smokey's Lighter"

--Quest5 Horde

Inst22Quest5_HORDE = "5. The Restless Souls"
Inst22Quest5_HORDE_Attain = "55"
Inst22Quest5_HORDE_Level = "60"
Inst22Quest5_HORDE_Aim = "Use Egan's Blaster on the ghostly and spectral citizens of Stratholme. When the restless souls break free from their ghostly shells, use the blaster again - freedom will be theirs!\nFree 15 Restless Souls and return to Egan."
Inst22Quest5_HORDE_Location = "Egan (Eastern Plaguelands(NW); "..YELLOW.."14,33"..WHITE..")"
Inst22Quest5_HORDE_Note = "You get the prequest from Caretaker Alen (Eastern Plaguelands; "..YELLOW.."79,63"..WHITE..")\nThe spectral citizens walk through whole Stratholme."
Inst22Quest5_HORDE_Prequest = "Yes, The Restless Souls"
Inst22Quest5_HORDE_Folgequest = "No"
--
...
Inst22Quest6_HORDE = "6. Of Love and Family (Questline)"
Inst22Quest6_HORDE_Attain = "53"
Inst22Quest6_HORDE_Level = "60"
Inst22Quest6_HORDE_Aim = "Travel to Stratholme, in the northern part of the Plaguelands. It is in the Scarlet Bastion that you will find the painting 'Of Love and Family,' hidden behind another painting depicting the twin moons of our world.\nReturn the painting to Tirion Fordring."
Inst22Quest6_HORDE_Location = "Artist Renfray (Western Plaguelands; "..YELLOW.."65,75"..WHITE..")"
Inst22Quest6_HORDE_Note = "You get the prequest from Tirion Fordring(Western Plaguelands; "..YELLOW.."7,43"..WHITE..").\nYou can find the picture near "..YELLOW.."[7]"..WHITE.."."
Inst22Quest6_HORDE_Prequest = "Yes, Redemption - > Of Love and Family"
Inst22Quest6_HORDE_Folgequest = "Yes, Find Myranda"
Inst22Quest6PreQuest_HORDE = "true"

--Quest7 Horde

Inst22Quest7_HORDE = "7. Menethil's Gift (Questline)"
Inst22Quest7_HORDE_Attain = "53"
Inst22Quest7_HORDE_Level = "60"
Inst22Quest7_HORDE_Aim = "Travel to Stratholme and find Menethil's Gift. Place the Keepsake of Remembrance upon the unholy ground."
Inst22Quest7_HORDE_Location = "Leonid Barthalomew the Revered (Eastern Plaguelands; "..YELLOW.."80,58"..WHITE..")"
Inst22Quest7_HORDE_Note = "You get the prequest from Magistrat Marduke (Western Plaguelands; "..YELLOW.."70,73"..WHITE..").\nYou find the sign near "..YELLOW.."[15]"..WHITE..". See also: "..YELLOW.."[The Lich Ras Frostraunen]"..WHITE.." in Scholomance."
Inst22Quest7_HORDE_Prequest = "Yes, The Human Ras Frostraunen - > The Dying, Ras Frostwhisper"
Inst22Quest7_HORDE_Folgequest = "Yes, Menethil's Gift"
Inst22Quest7PreQuest_HORDE = "true"

--Quest8 Horde

Inst22Quest8_HORDE = "8. Aurius' Reckoning"
...
Inst22Quest8_HORDE_Note = "To start the quest you have to give Aurius the [The Medallion of Faith]. You get the Medallion from a chest(Malor's Strongbox) near "..YELLOW.."[6]"..WHITE..". After giving Aurius the Medallion he supports your group in the fight against the Baron("..YELLOW.."[15]"..WHITE.."). After killing the Baron you have to talk to Aurius again to get the Rewards."
Inst22Quest8_HORDE_Prequest = "No"
Inst22Quest8_HORDE_Folgequest = "No"
--
...
Inst22Quest9_HORDE = "9. The Archivist"
Inst22Quest9_HORDE_Attain = "55"
Inst22Quest9_HORDE_Level = "60"
Inst22Quest9_HORDE_Aim = "Travel to Stratholme and find Archivist Galford of the Scarlet Crusade. Destroy him and burn down the Scarlet Archive."
Inst22Quest9_HORDE_Location = "Duke Nicholas Zverenhoff (Eastern Plaguelands; "..YELLOW.."81, 59"..WHITE..")"
Inst22Quest9_HORDE_Note = "You can find the Archive and the Achivist at "..YELLOW.."[6]"..WHITE.."."
Inst22Quest9_HORDE_Prequest = "No"
Inst22Quest9_HORDE_Folgequest = "Yes, The Truth Comes Crashing Down"

--Quest10 Horde

Inst22Quest10_HORDE = "10. The Truth Comes Crashing Down"
Inst22Quest10_HORDE_Attain = "58"
Inst22Quest10_HORDE_Level = "60"
Inst22Quest10_HORDE_Aim = "Take the Head of Balnazzar to Duke Nicholas Zverenhoff in the Eastern Plaguelands."
Inst22Quest10_HORDE_Location = "Balnazzar (Stratholme; "..YELLOW.."[7]"..WHITE..")"
Inst22Quest10_HORDE_Note = "You find Duke Nicholas Zverenhoff in the Eastern Plaguelands("..YELLOW.."81, 59"..WHITE..")."
Inst22Quest10_HORDE_Prequest = "Yes, The Archivist"
Inst22Quest10_HORDE_Folgequest = "Yes, Above and Beyond"
Inst22Quest10FQuest_HORDE = "true"

--Quest11 Horde

Inst22Quest11_HORDE = "11. Above and Beyond"
Inst22Quest11_HORDE_Attain = "58"
Inst22Quest11_HORDE_Level = "60"
Inst22Quest11_HORDE_Aim = "Venture to Stratholme and destroy Baron Rivendare. Take his head and return to Duke Nicholas Zverenhoff."
Inst22Quest11_HORDE_Location = "Duke Nicholas Zverenhoff (Eastern Plaguelands; "..YELLOW.."81, 59"..WHITE..")"
Inst22Quest11_HORDE_Note = "You can find the Baron at "..YELLOW.."[15]"..WHITE.."."
Inst22Quest11_HORDE_Prequest = "Yes, The Truth Comes Crashing Down"
Inst22Quest11_HORDE_Folgequest = "No"
--
...
Inst22Quest12_HORDE_Aim = "Travel to Stratholme and slay Ramstein the Gorger. Take his head as a souvenir for Nathanos."
Inst22Quest12_HORDE_Location = "Nathanos Blightcaller (Eastern Plaguelands; "..YELLOW.."26, 74"..WHITE..")"
Inst22Quest12_HORDE_Note = "You get the prequest from Nathanos Blightcaller, too.\nYou can find Ramstein at "..YELLOW.."[14]"..WHITE.."."
Inst22Quest12_HORDE_Prequest = "Yes, The Ranger Lord's Behest -> Duskwing, Oh How I Hate Thee..."
Inst22Quest12_HORDE_Folgequest = "No"
--
...
Inst37Caption = "HC: The Blood Furnaces"
...
Inst38Caption = "HC: The Shattered Halls"
