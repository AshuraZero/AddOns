...
ATLASLOOT_DEFIASSET = "S) 套装: 迪菲亚皮甲 (5件套)";
...
ATLASLOOT_OPTIONS_MINIMAP = "显示小地图按钮";
ATLASLOOT_OPTIONS_MINIMAPPOS = "小地图按钮位置";
...
ATLASLOOT_PANEL_BUTTON_PVP = "PvP 套装";
...
ATLASLOOT_MINIMAPBUTTON_LINE1 = "|cff1eff00点击左键|r 查看掉落表";
ATLASLOOT_MINIMAPBUTTON_LINE2 = "|cffff0000点击右键|r 打开选项";
