...
function AtlasLootRepButton_OnClick(setid, text)
    ...
    getglobal("AtlasLootItemsFrame_NEXT"):Hide();
    getglobal("AtlasLootItemsFrame_PREV"):Hide();
    if (setid=="Darkmoon" or setid=="Timbermaw" or setid=="Sporeggar1" or setid=="Kurenai1" or setid=="Consortium1" or setid=="Legendaries") then
...
function AtlasLoot_Rep(setid, text)
    ...
    elseif(setid=="Scryer2") then
        ...
        getglobal("AtlasLootItemsFrame_PREV"):Show();
    elseif(setid=="WorldDrop1") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, ATLASLOOT_FACTION_WORLDP..": "..ATLASLOOT_WEAPONS, AtlasLoot_AnchorFrame);
        getglobal("AtlasLootItemsFrame_NEXT").lootpage="WorldDrop2";
        getglobal("AtlasLootItemsFrame_NEXT"):Show();
    elseif(setid=="WorldDrop2") then
        AtlasLoot_ShowItemsFrame(setid, AtlasLootRepItems, ATLASLOOT_FACTION_WORLDP..": "..ATLASLOOT_ARMOR, AtlasLoot_AnchorFrame);
        getglobal("AtlasLootItemsFrame_PREV").lootpage="WorldDrop1";
        getglobal("AtlasLootItemsFrame_PREV"):Show();
    elseif(this:GetName()=="AtlasLootItemsFrame_NEXT" or this:GetName()=="AtlasLootItemsFrame_PREV") then
...
function AtlasLootRepMenu()
    ...
    AtlasLoot_SetItemInfoFrame(AtlasLoot_AnchorFrame);
    --World Drop
    AtlasLootMenuItem_7_Name:SetText(ATLASLOOT_FACTION_WORLDP);
    AtlasLootMenuItem_7_Extra:SetText("");
    AtlasLootMenuItem_7_Icon:SetTexture("Interface\\Icons\\INV_Staff_29");
    AtlasLootMenuItem_7.type="Factions";
    AtlasLootMenuItem_7.lootpage="WorldDrop1";
    AtlasLootMenuItem_7.text=ATLASLOOT_FACTION_WORLDP;
    AtlasLootMenuItem_7:Show();
    --Legendaries
    AtlasLootMenuItem_22_Name:SetText(ATLASLOOT_LEGENDARIES);
    AtlasLootMenuItem_22_Extra:SetText("");
    AtlasLootMenuItem_22_Icon:SetTexture("Interface\\Icons\\INV_Sword_39");
    AtlasLootMenuItem_22.type="Factions";
    AtlasLootMenuItem_22.text=ATLASLOOT_LEGENDARIES;
