                        ...
                        if(AtlasLootBossButtons[zoneID][i] ~= nil and AtlasLootBossButtons[zoneID][i] ~= "") then
                            ...
                            if(getglobal("AtlasText_"..i):GetText() == nil and getglobal("AtlasText_"..i-1):GetText() == nil and getglobal("AtlasText_"..i-2):GetText() ~= nil) then
                                if(zoneID == "TheRuinsofAhnQiraj") then
                                    getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_CLASS_BOOKS);
                                elseif(zoneID == "DireMaulNorth") then
                                    getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_TRIBUTE_RUN);
                                elseif(zoneID == "WailingCaverns") then
                                    getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_VIPERSET);
                                elseif(zoneID == "TheDeadmines") then
                                    getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_DEFIASSET);
                                else
                                    getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_TRASH_MOBS);
                                end
                            elseif(((zoneID == "BlackrockSpireUpper") or (zoneID == "BlackrockSpireLower")) and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_TRASH_MOBS) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_T0_SET_PIECES);
                            elseif(((zoneID == "DireMaulEast") or (zoneID == "DireMaulWest")) and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_TRASH_MOBS) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_DM_BOOKS);
                            elseif(zoneID == "ScarletMonastery" and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_TRASH_MOBS) then
                            ...
                            elseif(zoneID == "TheTempleofAhnQiraj" and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_AQ_ENCHANTS) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_AQ40_BROOD_RINGS);
                            elseif(zoneID == "TheTempleofAhnQiraj" and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_AQ40_BROOD_RINGS) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_AQ40_CLASS_SET_PIECES_1);
                            elseif(zoneID == "TheTempleofAhnQiraj" and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_AQ40_CLASS_SET_PIECES_1) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_AQ_OPENING);
                            elseif(zoneID == "TheRuinsofAhnQiraj" and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_CLASS_BOOKS) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_AQ_ENCHANTS);
                            elseif(zoneID == "TheRuinsofAhnQiraj" and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_AQ_ENCHANTS) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_AQ20_CLASS_SET_PIECES_1);
                            elseif((zoneID == "ZulGurub") and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_TRASH_MOBS) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_RANDOM_LOOT);
                            elseif((zoneID == "ZulGurub") and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_RANDOM_LOOT) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_ZG_CLASS_SET_PIECES_1);
                            elseif((zoneID == "ZulGurub") and getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_ZG_CLASS_SET_PIECES_1) then
                    ...
                    for i = 1, 27, 1 do
                        if(AtlasLootBattlegrounds[zoneID][i] ~= nil and AtlasLootBattlegrounds[zoneID][i] ~= "") then
                            ...
                            elseif(getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_BG_HONORED) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_BG_REVERED);
                            elseif(getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_BG_REVERED) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_BG_EXALTED);
                            elseif(getglobal("AtlasBossLine_"..(i-1).."_Text"):GetText() == ATLASLOOT_BG_EXALTED) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_PVP_SET_PIECES);
                            elseif(getglobal("AtlasText_"..i):GetText() == nil) then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(ATLASLOOT_BG_FRIENDLY);
                            end
                            getglobal("AtlasBossLine_"..i.."_Loot"):Show();
                            getglobal("AtlasBossLine_"..i.."_Selected"):Hide();
                            getglobal("AtlasText_"..i):Hide();
...
function AtlasLootBoss_OnClick(id)
    ...
    if ( ( AtlasLootItemsFrame.activeBoss ) and ( AtlasLootItemsFrame.activeBoss == id ) ) then
		...
		local boss = getglobal("AtlasBossLine_"..id.."_Text"):GetText();
        local a = strfind(boss, ")");
        if(a==12) then
            boss = strsub(boss, 3);
        else
            boss = strsub(boss, 4);
