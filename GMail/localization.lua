...
GMAIL_MASS_MAIL="Mass Mail";
GMAIL_FORWARD="Forward"

GMAIL_NOSUBJECT="<No Subject>"
GMAIL_UNKNOWNSENDER="<Unknown Sender>"
GMAIL_OPEN_FORMAT1="GMail: Mail |c00FFFFFF%d|r/|c00FFFFFF%d|r is Cash on Delivery, skipping."
GMAIL_OPEN_FORMAT2="GMail: Mail |c00FFFFFF%d|r/|c00FFFFFF%d|r has no money or items, skipping."
GMAIL_OPEN_FORMAT3="GMail: Opening mail |c00FFFFFF%d|r/|c00FFFFFF%d|r: \"|c00FFFFFF%s|r\" from |c00FFFFFF%s|r."
