...
TB_GUI_RemoveBuffs = "Buff去除";
TB_GUI_RemoveBuffsAlways = "总是删除BUFF包括:";
TB_GUI_DisableInBG = "禁用在战场";
TB_GUI_RemoveBuffsDefensive = "只在防御姿态:";
TB_GUI_RemoveBuffsBear = "只在熊形态:";
TB_GUI_EnableMBRecovery = "使失败的嘲讽恢复通告";
...
TB_defaultText_r = "- 我的惩戒打击恢复了我的嘲讽抵抗! -";

TB_tauntLine = "你的嘲讽被(%w+)抵抗了。";
TB_growlLine = "你的低吼被(%w+)抵抗了。";
TB_PLLine = "你的变形术被(%w+)抵抗了。";
TB_CSPLine = "你的法术反制被(%w+)抵抗了。";
TB_PLPLine = "你的变形术：猪被(%w+)抵抗了。";
TB_PLTLine = "你的变形术：龟被(%w+)抵抗了。";
TB_BNLine = "你的放逐术被(%w+)抵抗了。";
TB_mbHitLine = "你的惩戒痛击击中(.+)造成(.+)";
...
TB_output_buffremoved = " 删除.匹配 "; --As in ["Greater Blessing of Salvation" removed, matched "Salvation"]
