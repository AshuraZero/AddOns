...
DCR_STR_NEED_CURE_ACTION_IN_BARS = 'Decursive was unable to find any curing spell in one of your action bars. Decursive needs this to check the range.';
...
DCR_FAST_RANGE_CHECK= "Enable fast (not accurate) range check";
DCR_DONOT_BL_PRIO   = "Don't blacklist priority list names";
DCR_CHOOSE_CURE	    = "Cure:";
DCR_ABORT_SIP	    = "Abort spells in progress before curing";
...
DCR_USER_CHECK_DETECT2  = "CHECK";
DCR_USER_CHECK_RESPONSE = "Name: %s  /  Class: %s  /  Version: %s";
