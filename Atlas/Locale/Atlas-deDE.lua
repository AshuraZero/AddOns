...
Atlas_MapTypes = {
	"Instanzen der \195\150stlichen K\195\182nigreiche",
	"Instanzen von Kalimdor",
	"Instanzen der Scherbenwelt",
	"Schlachtfeldkarten",
	"Fluglinienkarten",
	"Dungeon Standorte",
	"Schlachtzugbosse"
...
AtlasEK = {
	...
	Naxxramas = {
		...
		_RED..INDENT..INDENT.."Thane Korth'azz, Lady Blaumeux";
		_RED..INDENT..INDENT.."Hochlord Mograine, Sire Zeliek";
...
AtlasBG = {
	...
	WarsongGulch = {
		...
		Acronym = "WS";
		Location = "Ashenvale / Brachland";
		BLUE.."A) Feste Silverwing (Allianz)";
		BLUE.."B) S\195\164gewerk der Warsong (Horde)";
	};
};
...
AtlasDL = {
	...
	DLWest = {
		...
		GREY.."6) Der Kral von Razorfen, ".._RED.."Brachland";
		GREY.."7) Die H\195\188gel von Razorfen , ".._RED.."Brachland";
...
AtlasRE = {
	Azuregos = {
		ZoneName = "Azuregos";
		Location = "Azshara, Southridge-Strand";
		GREY.."1) Azuregos";
	};
	FourDragons = {
		...
		GREY.."3) Feralas, Traum-Ge\195\164st";
		GREY.."4) Ashenvale, Schattengr\195\188n";
	};
	Kazzak = {
