...
BabbleSpell:RegisterTranslations("zhCN", function()
	return {
		...
		["Cheap Shot"] = "偷袭",
		["Chilled"] = "冰冻",
		["Circle of Healing"] = "极效治疗",  --  Need to translated
		["Claw"] = "爪击",
		["Cleanse"] = "清洁术",
		["Clearcasting"] = "节能施法",
		["Cleave"] = "顺劈斩",
		["Clever Traps"] = "灵巧陷阱",
		["Cloak of Shadows"] = "笼罩阴影",  --  Need to translated
		["Closing"] = "关闭",
		["Cloth"] = "布甲",
		...
		["Conjure Water"] = "造水术",
		["Consecrated Sharpening Stone"] = "神圣磨刀石",  --  Need to translated
		["Consecration"] = "奉献",
		["Consume Magic"] = "吞噬魔法",  --  Need to translated
