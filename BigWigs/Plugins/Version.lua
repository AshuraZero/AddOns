...
L:RegisterTranslations("zhCN", function() return {
	...
	["Green versions are newer than yours, red are older, and white are the same."] = "绿色版本比你的更新，红色更老，白色也一样.",
	["Player"] = "玩家",
	["Version"] = "版本",
	["Current zone"] = "当前区域",
	["<zone>"] = "<区域>",
	["Version query done."] = "已完成版本查询.",
	["Runs a version query on your current zone."] = "在当前区域运行一个版本查询.",
	["Closes the version query window."] = "关闭“版本查询”窗口.",
	["current"] = "当前",
	["Runs a version query on the given zone."] = "在给定区域上运行版本查询.",
	["Zone"] = "区域",
	["zone"] = "区域",
	["N/A"] = "N/A",
	["BigWigs"] = "BigWigs",
	["Runs a version query on the BigWigs core."] = "运行于BigWigs的核心版本查询.",
	["Nr Replies"] = "Nr 回复",
	["Ancient"] = "古老",
	...
	if not self.OutOfDateShown then
        ...
        StaticPopupDialogs["BigWigsOutOfDateDialog"] = {
            ...
            OnShow = function (self, data)
                ...
                editbox:SetText("http://qcat1989.lofter.com")
