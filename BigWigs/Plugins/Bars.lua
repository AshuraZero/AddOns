...
L:RegisterTranslations("zhCN", function() return {
	...
	["Options for the timer bars."] = "定时器条选项.",
	["Show the bar anchor frame."] = "显示锚框架.",
	["Set the bar scale."] = "设置条大小.",
	["Group upwards"] = "向上",
	["Toggle bars grow upwards/downwards from anchor."] = "切换锚的条向上/向下.",

	["Timer bars"] = "计时条",
	["Show anchor"] = "显示锚点",
	["Grow bars upwards"] = "条向上生长",
	["Scale"] = "大小",
	["Bar scale"] = "条大小",

	["Bars now grow %2$s"] = "条现在是 %2$s",
	["Scale is set to %2$s"] = "大小设置成 %2$s",
	...
	["Texture"] = "纹理",
	["Set the texture for the timerbars."] = "为计时条设置纹理.",
    ...
    ["Reverse"] = "反向",
	["Toggles if bars are reversed (fill up instead of emptying)."] = "条反转切换（填补不排空）。",
    ["Emphasize"] = "关键技能大小",
	["Emphasize bars that are close to completion (<10sec). Also note that bars started at less than 15 seconds initially will be emphasized right away."] = "技能接近完成的条 (小于10秒).",
    ["Enable"] = "启用",
	["Enables emphasizing bars."] = "启用关键技能提示条.",
    ["Flash"] = "闪光",
	["Flashes the background red for bars that are emphasized."] = "为关键技能提示的条闪烁背景红色.",
    ["Move"] = "移动",
	["Move bars that are emphasized to a second anchor."] = "移动关键技能提示条的锚点.",
    ["Set the scale for emphasized bars."] = "设置关键技能提示条的规模.",
    ["Emphasize Bars"] = "关键技能提示条",
} end)
