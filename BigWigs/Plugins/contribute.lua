...
L:RegisterTranslations("zhCN", function() return {
    ["This |cf75DE52fClassic-WoW|r Version was made by |cff7f7fffDorann|r."] = "这是 |cf75DE52fWoW60|r 版本是由 |cff7f7fffDorann|r.",
	["This addon is still work in progress and content is adjusted by |cff7f7fffDorann|r. Check for Updates or help by providing twitch/youtube footage on https://github.com/xorann/BigWigs/releases "] = "这插件它仍然是在进步和工作内容的调整 |cff7f7fffDorann|r.",
    ["This version of BigWigs is |cffff0000not intended for your realm|r. Please be aware that |cffff0000timers might be wrong or not working at all|r."] = "这版本是 BigWigs |cffff0000专门为AEDZ服打造|r. 请注意 |cffff0000其他服务器定时器可能是错误的或根本不工作|r."
} end)
