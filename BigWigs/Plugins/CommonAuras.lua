...
L:RegisterTranslations("zhCN", function() return {
	...
	["Toggle %s display."] = "切换 %s 显示.",
	["Portal"] = "传送门",
	["broadcast"] = "技能广播",
	["Broadcast"] = "技能广播",
	["Toggle broadcasting the messages to the raidwarning channel."] = "切换广播消息到团队警报频道。",

	["Gives timer bars and raid messages about common buffs and debuffs."] = "给计时条和团队消失关于一些BUFF和DEbuff.",
	["Common Auras"] = "常见的光环",
	["commonauras"] = "常见的光环",
} end )
