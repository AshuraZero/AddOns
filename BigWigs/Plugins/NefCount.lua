...
L:RegisterTranslations("zhCN", function() return {
	...
	["Nefarian landing! %s kills counted."] = "奈法利安降落！ %s 杀死计数.",
	["%d %s"] = "%d %s",
	[", "] = ", ",
	[" and "] = " 和 ",
	...
	["warn_cmd"] = "warn",
	["warn_name"] = "警告消息",
	["warn_desc"] = "显示警告消息在30和35龙兽杀死",
	["swarns_cmd"] = "swarns",
	["swarns_name"] = "单独的警告信息",
	["swarns_desc"] = "显示警告消息在 10 和 15 每种颜色龙兽杀死",
	["print_cmd"] = "print",
	["print_name"] = "发送消息龙兽计数",
	["print_desc"] = "发送消息龙兽计数在聊天窗口中",
} end)
