...
L:RegisterTranslations("zhCN", function() return {
	...
	["Options for the message frame."] = "消息框的选项.",
	["Anchor"] = "锚点",
	["Show the message anchor frame."] = "显示消息框锚点.",
	["Use RaidWarning"] = "使用团队警报",
	["Toggle sending messages to the RaidWarnings frame."] = "切换到团队警报框发送消息.",
	["Use colors"] = "使用颜色",
	["Toggles white only messages ignoring coloring."] = "消息忽略着色.",
	["Message frame scale"] = "消息框大小",

	["Message frame"] = "消息框",
	["Show anchor"] = "显示锚点",
	["Send messages to RaidWarning frame"] = "发信息给团队警报框架",
	["Set the message frame scale."] = "设置消息框大小.",
	["Colorize messages"] = "彩色的消息",
	["Scale"] = "大小",

	["|cffff0000Co|cffff00fflo|cff00ff00r|r"] = "|cffff0000颜色|cffff00ff颜色|cff00ff00颜色|r",
	["White"] = "白色",
	["BigWigs frame"] = "BigWigs 框架",
	["RaidWarning frame"] = "团队警报框架",
	["Scale is set to %s"] = "大小设置成 %s",
	...
	["Mik's Scrolling Battle Text"] = "Mik's 战斗文字滚动",
	["Scrolling Combat Text"] = "滚动的战斗文字",
