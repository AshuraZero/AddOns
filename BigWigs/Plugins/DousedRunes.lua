...
L:RegisterTranslations("zhCN", function() return {
	...
	["Doused Runes"] = "MC灭火提示",
	["Disabled"] = "禁用",
    ["Options for the doused runes Display."] = "MC灭火符文显示选项",
    ["Show frame"] = "显示框架",
    ["Show the doused runes frame."] = "显示MC灭火符文框架.",
    ["Show on douse"] = "显示扑灭",
    ["Show the display after a rune is doused."] = "显示后一个符文扑灭显示.",
    ["Show on Boss Kill"] = "显示在BOSS击杀",
	["Show the display after a boss has been killed."] = "在BOSS被杀死后显示.",
    ["Reset position"] = "重置位置",
	["Reset the frame position."] = "重置框架位置.",
    ["font"] = "Fonts\\FRIZQT__.TTF",     
            
    ["Ich habe die Rune von (%w+) gel"] = "我已把符文 (%w+) 扑灭", -- douse trigger (always german on Nefarian)
} end)
