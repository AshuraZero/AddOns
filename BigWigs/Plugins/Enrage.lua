...
L:RegisterTranslations("zhCN", function() return {
	["Enrage"] = "激怒", -- module name
	["enrage"] = "enrage", -- console command
	
	 -- console options
	["Options for the enrage plugin."] = "激怒的插件选项",
	["Show anchor"] = "显示锚点",
	["Show the bar anchor frame."] = "显示锚点条框架",
	["Reset position"] = "重置位置",
	["Reset the anchor position, moving it to the original position."] = "重置锚的位置，移动到原来的位置.",
	["Scale"] = "大小",
	["Set the frame scale."] = "设置框架大小",
	["Texture"] = "纹理",
