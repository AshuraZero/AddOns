...
L:RegisterTranslations("zhCN", function() return {
	...
	flamebuffetafflicted_trigger = "受到了龙翼打击",
	flamebuffetresisted_trigger = "费尔默龙翼打击被抵抗了。",
	flamebuffetimmune_trigger = "费尔默的龙翼打击施放失败。(.+)对此免疫。",
	flamebuffetabsorb1_trigger = "你吸收了费尔默的龙翼打击。",
	flamebuffetabsorb2_trigger = "费尔默的龙翼打击被(.+)吸收了。",
