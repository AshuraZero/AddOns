...
L:RegisterTranslations("zhCN", function() return {
	...
	toxicvolley_bar = "毒性箭雨",
	toxicvolley_message = "毒性箭雨 3 秒!",

	panic_trigger = "受到了恐慌效果的影响。",
	panicresist_trigger = "恐慌效果抵抗了",
	panicimmune_trigger = "恐慌施放失败。(.+)对此免疫。",
	
    toxicvaporsyou_trigger = "你受到了毒性箭雨效果的影响\。",
	toxicvaporsother_trigger = "(.+)受到了毒性箭雨效果的影响\。",
	
	toxicvaporsyou_trigger2 = "你受到(%d+)点(.+)伤害（亚尔基公主的毒性箭雨）。",
	toxicvaporsother_trigger2 = "亚尔基公主的毒性箭雨使(.+)受到了(%d+)点(.+)伤害。",
