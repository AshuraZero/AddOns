...
L:RegisterTranslations("zhCN", function() return {
	...
	plagueyou_name = "瘟疫在你 警报",
	plagueyou_desc = "如果你中了瘟疫警报",

	plagueother_cmd = "plagueother",
	plagueother_name = "瘟疫在其他人警报",
	plagueother_desc = "如果其他人中了瘟疫警报",

	thunderclap_cmd = "thunderclap",
	thunderclap_name = "雷霆一击警报",
	thunderclap_desc = "雷霆一击警报",
	...
	icon_cmd = "icon",
	icon_name = "头像图标",
	icon_desc = "将RAID图标放在最后瘟疫的人身上 (需要A或L)",
	...
	summonguardwarn = "虫群卫士召唤",
	summonwarriortrigger = "阿努比萨斯防御者施放了召唤阿努比萨斯战士。",
	summonwarriorwarn = "战士召唤",
	plaguetrigger = "^([^%s]+)受到了瘟疫效果的影响",
	plaguewarn = " 是瘟疫!",
	plagueyouwarn = "你是瘟疫!",
	plagueyou = "你",
	plagueare = "的",
