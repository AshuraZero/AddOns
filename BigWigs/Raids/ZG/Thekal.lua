...
L:RegisterTranslations("zhCN", function() return {
	...
	forcepunch_trigger = "高阶祭司塞卡尔开始施展重击。",
	forcepunch_bar = "重击",
	heal_trigger = "狂热者洛卡恩开始施放强效治疗术。",
	enrage_trigger = "高阶祭司塞卡尔获得了激怒的效果\。",
	...
	silence_bar = "沉默: %s",
	disarm_bar = "缴械: %s",
	bloodlustgain = "(.+)获得了嗜血术效果的影响。",
	bloodlustend = "嗜血术效果从(.+)身上消失。",
	bloodlust_bar = "嗜血术: %s",
	bloodlustannounce = "驱散嗜血术 %s!",
	frenzybegin_trigger = "高阶祭司塞卡尔获得了狂乱效果。",
	frenzyend_trigger = "狂乱效果从高阶祭司塞卡尔身上消失。",
	frenzyann = "狂乱! 立刻宁神!",
	frenzy_bar = "狂乱",
	death_trigger = "死亡了。",
	zath_trigger = "狂热者扎斯",
	lorkhan_trigger = "狂热者洛卡恩",
	thekal_trigger = "高阶祭司塞卡尔",
	thekalrescast_trigger = "高阶祭司塞卡尔开始施放复活术。",
