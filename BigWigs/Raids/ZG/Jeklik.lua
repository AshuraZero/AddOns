...
L:RegisterTranslations("zhCN", function() return {
	...
	fearrep_trigger1 = "恐吓尖啸效果的影响",
	fearrep_trigger2 = "恐吓尖啸被抵抗了",
	fearrep_trigger3 = "恐吓尖啸施放失败。(.+)对此免疫。",
	fearrep_trigger4 = "心灵尖啸效果的影响",
	fearrep_trigger5 = "心灵尖啸被抵抗了",
	fearrep_trigger6 = "心灵尖啸施放失败。(.+)对此免疫。",
	attack_trigger1 = "高阶祭司耶克里克发起了攻击",
	attack_trigger2 = "高阶祭司耶克里克没有击中",
	attack_trigger3 = "高阶祭司耶克里克击中",
	attack_trigger4 = "高阶祭司耶克里克的致命一击",
	liquidfire_trigger = "投掷燃烧瓶",
	...
	phasetwo_trigger = "悬浮效果从高阶祭司耶克里克身上消失\。",
	heal_trigger = "高阶祭司耶克里克开始施放强效治疗术\。",
