...
L:RegisterTranslations("zhCN", function() return {
	...
	siphon_trigger = "哈卡获得了血液虹吸效果。",
	poisonousblood_trigger = "你受到了酸性血液效果的影响。",
	mindcontrolyou_trigger = "你受到了疯狂效果的影响。",
	mindcontrolother_trigger = "(.+)受到了疯狂效果的影响。",
	flee_trigger = "Fleeing will do you no good, mortals!",
	aspectofthekal_trigger = "哈卡获得了塞卡尔的守护效果。",
	aspectofthekalend_trigger = "塞卡尔的守护效果从哈卡身上消失。",
	aspectofmarliyou_trigger = "你受到了玛尔里的守护效果的影响。",
	aspectofmarliyouimmune_trigger = "哈卡的玛尔里的守护施放失败。你对此免疫。",
	aspectofmarliother_trigger = "(.+)受到了玛尔里的守护效果的影响。",
	aspectofmarliotherimmune_trigger = "哈卡的玛尔里的守护施放失败。(.+)对此免疫。",
	aspectofmarligeneralavoid_trigger = "哈卡的玛尔里的守护",
	aspectofjeklikyou_trigger = "你受到了耶克里克的守护效果的影响。",
	aspectofjeklikyouimmune_trigger = "哈卡的耶克里克的守护施放失败。你对此免疫。",
	aspectofjeklikother_trigger = "(.+)受到了耶克里克的守护效果的影响。",
	aspectofjeklikotherimmune_trigger = "哈卡的耶克里克的守护施放失败。(.+)对此免疫。",
	aspectofjeklikgeneralavoid_trigger = "哈卡的耶克里克的守护",
	aspectofarlokkyou_trigger = "你受到了娅尔罗的守护效果的影响。",
	aspectofarlokkyouimmune_trigger = "哈卡的娅尔罗的守护施放失败。你对此免疫。",
	aspectofarlokkother_trigger = "(.+)受到了娅尔罗的守护效果的影响。",
	aspectofarlokkotherimmune_trigger = "哈卡的娅尔罗的守护施放失败。(.+)对此免疫。",
	aspectofarlokkgeneralavoid_trigger = "哈卡的娅尔罗的守护",
	aspectofvenoxisyou_trigger = "哈卡的温诺希斯的守护击中你造成",
	aspectofvenoxisyouresist_trigger = "哈卡的温诺希斯的守护被抵抗了。",
	aspectofvenoxisother_trigger = "哈卡的温诺希斯的守护击中",
	aspectofvenoxisotherresist_trigger = "哈卡的温诺希斯的守护被(.+)抵抗了。",

	siphon_warning = "血液虹吸 %d 秒!",
	siphon_message = "血液虹吸 - 下次90秒施放!",
	enrage5minutes_message = "激怒 5 分钟!",
	enrage1minute_message = "激怒 1 分钟!",
	enrageseconds_message = "激怒 %d 秒!",

	mindcontrol_message = "%s 被精神控制!",
	mindcontrol_message_you = "你被精神控制!",
	mindcontrol_bar = "精神控制: %s",
	firstmc_bar = "第一次精神控制",
	nextmc_bar = "下次精神控制",
	enrage_bar = "激怒",
	siphon_bar = "血液虹吸",
	aspectthekalnext_bar = "下次疯狂",
	aspectthekal_bar = "疯狂 - 塞卡尔的守护",
	aspectthekal_ann = "疯狂! 立刻宁神!",
	aspectmarli_bar = "下次昏迷",
	aspectmarlidebuff_bar = "昏迷: %s - 玛尔里的守护",
	aspectjeklik_bar = "下次沉默",
	aspectjeklikdebuff_bar = "沉默 - 耶克里克的守护",
	aspectarlokk_bar = "下次消失",
	aspectarlokkdebuff_bar = "消失: %s - 娅尔罗的守护",
	aspectvenoxis_bar = "下次毒药",
	aspectvenoxisdebuff_bar = "毒药 - 温诺希斯的守护",
